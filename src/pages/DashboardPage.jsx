    ...
    <div style={{ padding:"28px", maxWidth:"1200px" }}>
      ...
      <div className="fade-in" style={{ marginBottom:"30px" }}>
        ...
        <p style={{ fontFamily:"var(--font-body)", fontSize:"14px", color:"var(--color-text)", lineHeight:1.6 }}>
          Here's a summary of your recent market analysis activity.
        </p>
      </div>

      {/* Stat widgets */}
      <div className="fade-in fade-in-1" style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:"16px", marginBottom:"28px" }}>
        <StatWidget label="Saved Reports"   value="3"     sub="Last 30 days"
        ...
        />
        <StatWidget label="Avg. Feasibility" value="72%"  sub="Across all scans"
        ...
        />
        <StatWidget label="Locations Scanned" value="7"  sub="All time"
        ...
        />
        <StatWidget label="Data Coverage"   value="14.2 km²" sub="Total area analyzed"
      ...
      <div className="fade-in fade-in-2">
        <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:"16px" }}>
          ...
          <button
            ...
            style={{ fontFamily:"var(--font-body)", fontSize:"12px", fontWeight:600, color:"var(--color-brand)", background:"none", border:"none", cursor:"pointer" }}
          >
            View all →
          </button>
        </div>
          ...
          {MOCK_REPORTS.map((r) => (
            ...
            >
              ...
              <div style={{
                ...
                <span style={{ fontFamily:"var(--font-display)", fontSize:"15px", fontWeight:700, color: SCORE_COLOR(r.score) }}>
                  {r.score}
                </span>
              </div>
