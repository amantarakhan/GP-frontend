    ...
    <div style={{ padding: "28px" }}>
            ...
            {hasResults && (
              <button
                ...
                style={{
                  ...
                  background: saved ? "var(--color-success)" : "transparent",
                  color: "var(--color-brand)",
                  fontSize: "13px", fontWeight: 700, fontFamily: "var(--font-body)", cursor: "pointer",
                  transition: "all .2s",
                }}
              >
                {saved ? "✓ Saved!" : "Save Current Scan"}
              </button>
            )}
            <button
              ...
              style={{
                ...
                fontFamily: "var(--font-body)", cursor: "pointer", boxShadow: "0 4px 14px rgba(63,125,88,.35)",
              }}
            >
      ...
      {reports.length === 0 && (
        <div className="fade-in fade-in-1" style={{ textAlign: "center", padding: "60px 20px", background: "var(--color-card)", borderRadius: "var(--radius-lg)", border: "1px dashed var(--color-accent)" }}>
          ...
          <div style={{ fontFamily: "var(--font-display)", fontSize: "20px", fontWeight: 700, color: "var(--color-dark)", marginBottom: "8px" }}>No reports saved yet</div>
