...
// ═══════════════════════════════════════════════════════════════════════════════
// KEYFRAMES — identical to SignupPage for seamless continuity
// ═══════════════════════════════════════════════════════════════════════════════
const KEYFRAMES = `
...
// ═══════════════════════════════════════════════════════════════════════════════
// DOT GRID — identical pattern id differs to avoid SVG conflicts
// ═══════════════════════════════════════════════════════════════════════════════
const DotGrid = () => (
  <svg style={{ position:"absolute", inset:0, width:"100%", height:"100%", pointerEvents:"none" }}>
    ...
    <rect width="100%" height="100%" fill="url(#lg-dots)" opacity=".1"/>
  </svg>
);

// ═══════════════════════════════════════════════════════════════════════════════
// FLOATING LABEL FIELD — same component as SignupPage
// ═══════════════════════════════════════════════════════════════════════════════
    ...
    <>
      ...
      <div style={{
        ...
        <nav style={{
          ...
          {/* Floating seal — identical to SignupPage */}
          ...
          <div style={{ display:"flex", alignItems:"center", gap:"12px" }}>
            ...
            <button
              ...
              style={{
                ...
                color: signHov ? "#fff" : "var(--color-brand-dark)",
                background: signHov
        ...
        {/* ════════════════════════════════════════
            CINEMATIC CANVAS — pixel-perfect twin
        ════════════════════════════════════════ */}
        <main style={{
          ...
          {/* ── UPPER-LEFT CORNER GLOBE ── */}
          <img src={globeHero} alt="" aria-hidden="true" style={{
            position:"absolute", left:"0px", top:"2%",
            width:"340px", height:"auto",
            objectFit:"contain", pointerEvents:"none", userSelect:"none", zIndex:0,
            opacity:0.08,
            filter:
          ...
          {/* ── LOWER-RIGHT CORNER GLOBE with orbital arc ── */}
          <div style={{
            ...
            <svg width="340" height="340" viewBox="0 0 340 340"
              ...
              <circle cx="170" cy="170" r="162"
                fill="none" stroke="rgba(63,125,88,0.2)"
                strokeWidth="1" strokeDasharray="320 700"
                strokeDashoffset="0" strokeLinecap="round"/>
              <circle cx="170" cy="170" r="162"
                fill="none" stroke="rgba(63,125,88,0.08)" strokeWidth="0.5"/>
            </svg>
            <img src={globeHero} alt="" aria-hidden="true" style={{
          ...
          <div style={{
            ...
            {done ? (
              ...
              <>
                ...
                <div style={{ display:"flex", flexDirection:"column", gap:"26px", marginBottom:"16px" }}>
                  ...
                  <div>
                    <Field label="Email Address" icon={<Mail/>} type="email"
                      value={email} onChange={e=>setEmail(e.target.value)} delay=".06s"/>
                ...
                {/* Forgot password */}
                <div style={{
                  textAlign:"right", marginBottom:"28px",
                  animation:"field-rise .48s ease both", animationDelay:".2s",
                }}>
                  <button
