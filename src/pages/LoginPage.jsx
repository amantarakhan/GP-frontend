          ...
          <div style={{ display:"flex", alignItems:"center", gap:"12px" }}>
            ...
            <button onClick={() => navigate("/signup")}
              ...
              style={{
                ...
                background: signHov ? "linear-gradient(135deg,var(--color-brand) 0%,var(--color-brand-dark) 100%)" : "rgba(63,125,88,.08)",
          ...
          <div style={{
            ...
            {done ? (
              ...
              <>
                ...
                {/* Forgot password */}
                <div style={{ textAlign:"right", marginBottom:"28px", animation:"field-rise .48s ease both", animationDelay:".2s" }}>
                ...
                <button onClick={submit}
                  ...
                  style={{
                    ...
                    transform: btnHov&&!loading&&!googleLoading ? "translateY(-2px) scale(1.025)" : "translateY(0) scale(1)",
