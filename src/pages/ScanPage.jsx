      ...
      >
        ...
        <div className="fade-in" style={{ flexShrink: 0 }}>
          <h2 style={{
            ...
            color: "var(--color-dark)", letterSpacing: "-0.3px", marginBottom: "2px",
          }}>
            Target Location
          </h2>
        ...
        {/* Map */}
        <div
          className="fade-in fade-in-1 scan-map-container"
          style={{
            flex:         1,
