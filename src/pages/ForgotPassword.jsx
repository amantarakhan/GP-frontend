...
// ═══════════════════════════════════════════════════════════════════════════════
// KEYFRAMES — same system as SignupPage / LoginPage
// ═══════════════════════════════════════════════════════════════════════════════
const KEYFRAMES = `
  ...
  /* success-bloom — bouncy entrance for the checkmark state */
  @keyframes success-bloom {
    0%  { opacity: 0; transform: scale(.5) rotate(-15deg); }
    70% { transform: scale(1.12) rotate(3deg); }
    100%{ opacity: 1; transform: scale(1)  rotate(0deg); }
  }
  /* emerald-glow pulse on the check circle */
  @keyframes emerald-glow {
    0%,100% { box-shadow: 0 0 24px rgba(63,125,88,.35), 0 0 60px rgba(63,125,88,.12); }
    50%     { box-shadow: 0 0 40px rgba(63,125,88,.55), 0 0 100px rgba(63,125,88,.22); }
  }
